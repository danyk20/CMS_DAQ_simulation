...
def post_state_change(new_state: str, routing_key: str, debug: bool = False) -> None:
    """
    Send new state to the children node

    :param debug: whether print debug messages
    :param new_state: new state
    :param routing_key: binding key of nodes that should receive the new state
    :return: None
    """
    send_message(new_state, routing_key, STATE_EXCHANGE, debug)


def post_state_notification(current_state: str, routing_key: str, sender_id: str,  debug: bool = False) -> None:
    """
    ...
    :return: None
    """
    send_message(sender_id + ":" + current_state, routing_key, NOTIFICATION_EXCHANGE, debug)


def send_message(message: str, routing_key: str, exchange_name: str, debug: bool = False) -> None:
    """
